...
if flags.do_fig3
    figure;
    hold on;
    h=errorbar((1:4)-.02,nanmean(permute(nanmean(wILD_exp1(:,2:5,:)),[3 2 1])),(nanstd(permute(nanmean(wILD_exp1(:,2:5,:)),[3 2 1])))/sqrt(19),'bo-');
    set(h,'MarkerFaceColor','b','LineWidth',1.5,'MarkerSize',7);
    h=errorbar((2:3)+.02,nanmean(permute(nanmean(wILD_exp2(1:4,1:2,:)),[3 2 1])),(nanstd(permute(nanmean(wILD_exp2(1:4,1:2,:)),[3 2 1])))/sqrt(20),'r^-');
    set(h,'MarkerFaceColor','r','LineWidth',1.5,'MarkerSize',7);
    h=errorbar(2.5,nanmean(permute(nanmean(wILD_exp1(:,1,:)),[3 2 1])),(nanstd(permute(nanmean(wILD_exp1(:,1,:)),[3 2 1])))/sqrt(19),'bo');
    set(h,'MarkerFaceColor','b','LineWidth',1.5,'MarkerSize',7);
