...
%
%
%   References: barumerli2023 majdak2010 baumgartner2014modeling reijniers2014 middlebrooks1999nonindividualized  macpherson2003ripples
%
...
%         colororder([[55,126,184]./255-0.2; [77,175,74]./255-0.2])
        ...
        if isoctave
          ax = plotyy(fig2.pos, fig2.itd, fig2.pos, fig2.ild);
          ylabel(ax(1),'ITD [JND]');
          yticks(ax(1), sort([-15:7.5:15]))
          ylabel(ax(2), 'ILD [dB]');
          yticks(ax(2), ([-30:15:30]))
