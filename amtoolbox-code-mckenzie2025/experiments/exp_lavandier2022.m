...
%   jelfs2011
%
%   References: lavandier2022 lavandier2012 jelfs2011revision leclere2015 lavandier2008 vicente2020 rana2018 prudhomme2020 deroche2014 collin2013 vicente2020nh
...
if flags.do_fig5
    ...
    nerbs = 1:nerbs_step:round(f2erbrate(FS/2,'moore1983'));
    fc = zeros(1,length(nerbs));
    for i=1:length(fc)
        fc(i) = round(erbrate2f(nerbs(i),'moore1983'));
    end
