...
%display data
    ...
    fprintf('\nTab. I.:\n')
    fprintf('----------------------------------------------------------------------\n')
    fprintf('EST || r error (mm) | phi_e error (deg) | theta_e errror |  ANR (\xB5s)  \n')
    fprintf('----------------------------------------------------------------------\n')
    fprintf('----------------------------------------------------------------------\n')
    for ii=1:4
        fprintf(rows(ii,:))
        fprintf('   %4.1f \x00B1 %3.1f |        %4.1f \x00B1 %3.1f |     %4.1f \x00B1 %3.1f | %4.1f \x00B1 %3.1f\n',out(ii,:)');
    end
    fprintf('----------------------------------------------------------------------\n\n')
...
%display data
    ...
    fprintf('\nTab. II.:\n')
    fprintf('----------------------------------------------------------------------------------------------------------\n')
    fprintf('       ||     r error (mm)       |   phi_e error (deg)   |    theta_e errror     |       ANR (\xB5s)        \n')
...
%display data
    ...
    fprintf('\nTab. III.:\n')
    fprintf('-----------------------------------------------------------------------\n')
    fprintf('     | Ear || r (mm)       | phi_e (deg)  | theta_e (deg) |  ANR (\xB5s)  \n')
    fprintf('-----------------------------------------------------------------------\n')
    fprintf('-----------------------------------------------------------------------\n')
    for ii=1:4
        fprintf(rows(ii,:))
        fprintf(' %5.1f \x00B1 %4.1f | %5.1f \x00B1 %4.1f |   %5.1f \x00B1 %3.1f | %4.1f \x00B1 %4.1f\n',out(ii,:)');
    end
    fprintf('-----------------------------------------------------------------------\n\n')
...
%display data
    ...
    fprintf('\nTab. V.:\n')
    fprintf('-------------------------------------------------------------------------------------------------------------------------------------------------\n')
    fprintf('    | TOAset | Ear || r (mm)     | phi_e (deg) | theta_e (deg)| x_M (mm)    | y_M (mm)    | z_M (mm)    |  ANR (\xB5s)  \n')
    fprintf('-------------------------------------------------------------------------------------------------------------------------------------------------\n')
    fprintf('-------------------------------------------------------------------------------------------------------------------------------------------------\n')
    for ii=1:12
        fprintf(rows(ii,:))
        fprintf(' %4.1f \x00B1 %3.1f | %5.1f \x00B1 %3.1f |  %5.1f \x00B1 %4.1f | %4.1f \x00B1 %4.1f | %4.1f \x00B1 %4.1f | %4.1f \x00B1 %4.1f | %4.1f \x00B1 %4.1f\n',out(ii,:)');
    end
    fprintf('-------------------------------------------------------------------------------------------------------------------------------------------------\n\n')
...
%display data
    ...
    fprintf('\nTab. V.:\n')
    fprintf('-------------------------------------------------------------------------------------------------------------------------------------------------\n')
    fprintf('Condition    | TOAset | Ear || r error (mm) | phi_e error (deg) | theta_e errror | x_M error (mm) | y_M error (mm) | z_M error (mm) |  ANR (\xB5s)  \n')
    fprintf('-------------------------------------------------------------------------------------------------------------------------------------------------\n')
    fprintf('-------------------------------------------------------------------------------------------------------------------------------------------------\n')
    for ii=1:8
        fprintf(rows(ii,:))
        fprintf('   %4.1f \x00B1 %3.1f |        %4.1f \x00B1 %3.1f |     %4.1f \x00B1 %3.1f |     %4.1f \x00B1 %3.1f |     %4.1f \x00B1 %3.1f |     %4.1f \x00B1 %3.1f | %4.1f \x00B1 %3.1f\n',out(ii,:)');
    end
    fprintf('-------------------------------------------------------------------------------------------------------------------------------------------------\n\n')
