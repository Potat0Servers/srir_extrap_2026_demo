...
if flags.do_plot
    ...
    elseif flags.do_b_fig3
        ...
        subplot(3,2,1);
        if isoctave
          h = errorbar(bw,N0Spi125(:,1),N0Spi125(:,2),'-x'); %,'MarkerSize',10);
          set(h,'markersize',10);
        endif
        else
        ...
        subplot(3,2,2);
        if isoctave
          h = errorbar(bw,N0Spi250(:,1),N0Spi250(:,2),'-x'); %,'MarkerSize',10);
          set(h,'markersize',10);
        %endif
        else
        ...
        subplot(3,2,3);
        if isoctave
          h = errorbar(bw,N0Spi500(:,1),N0Spi500(:,2),'-x'); %,'MarkerSize',10);
          set(h,'markersize',10);
        else
        ...
        subplot(3,2,4);
        if isoctave
          h = errorbar(bw,N0Spi1000(:,1),N0Spi1000(:,2),'-x'); %,'MarkerSize',10);
          set(h,'markersize',10);
        %endif
        else
        ...
        subplot(3,2,5);
        if isoctave
          h = errorbar(bw,N0Spi2000(:,1),N0Spi2000(:,2),'-x'); %,'MarkerSize',10);
          set(h,'markersize',10);
        %endif
        else
        ...
        subplot(3,2,6);
        if isoctave
          h = errorbar(bw,N0Spi4000(:,1),N0Spi4000(:,2),'-x'); %,'MarkerSize',10);
          set(h,'markersize',10);
        %endif
        else
