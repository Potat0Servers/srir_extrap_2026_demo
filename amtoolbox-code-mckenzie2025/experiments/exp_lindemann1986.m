...
%             The output has the size: (*c_s* x *nitds* x *delay line length*).
%
...
%             The output has the size: (*c_s* x *nitds*).
%
...
%             cross-correlation result of the figure. The output has the
%             size: (*c_s* x *nilds* x *delay line length*).
%
...
%              result of the figure.  The output has the size:
%              (*c_s* x *nilds* x *delay line length*).
%
...
%              cross-correlation result of the to figure. The output has the size:
%              (*c_s* x *nilds* x *delay line length*). 
%
...
%              value.  The output has the size: *ITDs*.
%
...
%              The output has the size: (*ILDs* x *ITDs*).
%
...
%               the displacement of the centroid for different *c_s* values
%               and ILDs. The output has dimenthe size: (*c_s* x *nilds*).
%
...
%               The output has the size: (*nilds* x *nitds*).
...
%              has the size: (*c_s* x *nilds* x *delay line length*). 
%
...
%              ITD. The output has the size: *ITDs*.
%
...
%              the size: (*ITDs* x *ILDs*). 
%
%     'fig18'  Reproduce Fig.18 from Lindemann (1986). The cross-correlation
%              of pink noise with different interaural coherence (IC)values is
...
%              figure. The output has the size: (*ICs* x *delay line length*).
%
