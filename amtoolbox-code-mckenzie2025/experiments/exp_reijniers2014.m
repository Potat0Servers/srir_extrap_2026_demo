...
%   -------------
%
%   1) SOFA Toolbox v2.x or higher from 
%      http://sourceforge.net/projects/sofacoustics for Matlab
%
%   Examples:
%   ---------
%
...
%
%   To display Fig. 3 and do a quick recalculation use :::
%
...
%   #Author: Jonas Reijniers (201X): original implementation 
%   #Author: Roberto Barumerli (2019): Modified and adapted for the AMT
%   #Author: Michael Sattler (2019): Modified and adapted for the AMT
