...
%
%   `exp_baumgartner2013(..)` reproduces figures of the book 
%   chapter Baumgartner et al. (2013).
%
...
% 
%     'dtfs'       DTFs. Size: (*time* x *position* x *channel*).
...
%   #Author: Robert Baumgartner (2014): Original implementation. 
