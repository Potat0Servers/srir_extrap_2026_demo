...
%               of the lopezpoveda2001 filter for the different input levels.
%
...
%               The output has the size: (*signal levels* x *masker levels* x *frequency*). 
%               *masker levels* consists of 4 columns:
%
