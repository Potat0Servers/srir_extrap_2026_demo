...
%     H       : "Hurst" index of the resultant noise. Must be 0 < *H* $\leq$ 2).  
%               Determines the power spectral density of the output, which will
%               be nominally proportional to $1/f^{(2H-1)}$:
%               
%               - For 0 < *H* $\leq$ 1, the output will be fractional Gaussian noise 
%                 with the Hurst index *H*.  
%
%               - For 1 < *H* $\leq$ 2, the output will be fractional Brownian motion 
...
%   See also: zilany2014
%
%   References: davies1987 beran1994 bardet2002 zilany2014
