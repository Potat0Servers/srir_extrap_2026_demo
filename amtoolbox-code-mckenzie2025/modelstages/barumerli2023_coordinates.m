...
classdef barumerli2023_coordinates < matlab.mixin.Copyable

    properties (SetAccess = private) 
        % the following property validations are not supported by Octave:
    ...
    methods
        ...
        function obj_new = subset(obj, idx)
            obj_new = copy(obj); % matlab does a copy by reference otherwise
            obj_new.pos = obj_new.pos(idx,:);
        end
