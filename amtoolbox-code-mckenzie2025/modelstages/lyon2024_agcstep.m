function [state, updated] = lyon2024_agcstep(detects, coeffs, state)
%lyon2024_agcstep active gain control step of the CARFAC model
%   Usage: [state, updated] = lyon2024_agcstep(detects, coeffs, state);
%
%   Input parameters:
...
%   #License: Apache2
%   #Author: Richard F. Lyon (2013): Original implementation, as lyon2011_agcstep (https://github.com/google/carfac).
%   #Author: Amin Saremi (2016): Adaptations for the AMT, as lyon2011_agcstep.
%   #Author: Clara Hollomey (2021): Integration in the AMT 1.0, as lyon2011_agcstep.
%   #Author: Mihajlo Velimirovic (2022): Revert of the code to better correspond to https://github.com/google/carfac, as lyon2011_agcstep.
%   #Author: Clara Hollomey (2021): Integration in the AMT 1.3, as lyon2011_agcstep.
%   #Author: Piotr Majdak (2024): Rudimentary clean up for the AMT 1.6, as lyon2011_agcstep.
%   #Author: Piotr Majdak (2024): Copied from lyon2011_agcstep, adaptations for lyon2024 for AMT 1.6.
...
[state, updated] = local_agcrecurse(coeffs, AGC_in, stage, state); % required because called recursively
...
if decim_phase == 0
  ...
  % spatial smooth: 1 iteration, 3-tap FIR.
  FIR_coeffs = coeffs(stage).AGC_spatial_FIR;
  AGC_stage_state = ...
