...
%
%   Input parameters:
%     sofaFileName   : Filename of the SOFA file containing the HRIR set.
%     lat_angles     : Vector of lateral angles (in degrees) to extract. 
%     fs             : Sampling frequency (in Hz). 
%
%   Output parameters:
%     IRs            : Impulse responses. Size: (*direction* x *time* x *ear*).
%
