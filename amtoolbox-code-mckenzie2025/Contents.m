...
%   -------
%   
%   This is the most-complete and up-to-date description of the AMT. This documentation is directly included in the M-files and it is auto-generated for this website. Because of the automatic generation, the appearance on the website may suffer some details. Note that the current status of the models can be found in the section `Models <https://test.amtoolbox.org/models.php>`_ at this website.
%   
%   
%   New to the AMT? 
%   ---------------
%   
%   Download the `AMT full package <https://test.amtoolbox.org/download.php>`_, which provides all third-party toolboxes, and install the AMT with ``amt_start('install')``. This command also downloads the third-party toolboxes (if missing) and triggers compilation of the binaries. 
%
...
%
%   + The models |verhulst2012|, |verhulst2015|, and |verhulst2018| require `Python <https://www.python.org/>`_ (version >= 2.6) with the packages *numpy* and *scipy*. The availability of Python (and its version) can be checked with ``system('python -V')``. This information is also displayed by |amt_start|.
%
...
%
%   For more detailed information on the requirements and steps for installation, see the section "Installation" of the `Download <download.php>`_ website. 
%   
%   License:
%   --------
%   
