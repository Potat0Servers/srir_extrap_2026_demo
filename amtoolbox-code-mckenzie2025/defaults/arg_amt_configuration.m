...
definput.keyvals.badsfound = 'not initialized';
...
definput.keyvals.amt_folders(15).name = 'frambi';
definput.keyvals.amt_folders(16).name = 'oct';%this folder always needs to be the last in the list
...
definput.keyvals.ltfat = num2str('https://github.com/ltfat/ltfat/archive/refs/tags/v2.6.0.zip');
...
definput.keyvals.bads = num2str('https://github.com/acerbilab/bads/archive/refs/tags/v1.1.2.zip');
...
x=x(x~=10); x=x(x~=13); % remove LF and CF, if any
v=['amt-' char(x')];
definput.keyvals.version = {v, 'amt-1.6.0', 'amt-1.5.0', 'amt-1.4.0', 'amt-1.3.0', 'amt-1.2.0', 'amt-1.1.0', 'amt-1.0.0'};
