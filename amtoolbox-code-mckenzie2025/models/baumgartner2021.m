...
%
%   Input parameters:
%     target  : Binaural impulse responses referring to the directional 
...
%               listener-specific DTFs of the sagittal plane with the size:
%               (*time* x *direction* x *channel*).
