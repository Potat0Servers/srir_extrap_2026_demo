...
% 
%   Input parameters:
%     target_direct  : Binaural impulse responses or head-related impulse response
%                      of the target sound. Size: (*time* x *ear*).
%     template_direct: Binaural impulse response or head-related impulse response
%                      of the template sound. Size: (*time* x *ear*).
