...
%
%   FrAMBI models
%     BARUMERLI2024_ITDLATERAL - Very simple model to demonstrate FrAMBI functionality
%     BARUMERLI2024_MOCKUP - A mockup model to demonstrate FrAMBI functionality
%
