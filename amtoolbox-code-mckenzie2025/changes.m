...
%    - **New**:`eurich2024`: Efficient monaural and binaural model for audio quality assessment (eMoBi-Q).
...
%    - Issue #248 and #311: `moore2016`: Major code review. Level definition fixed, a demo added, plot and the stage `moore2016_cochlea` removed, but this model still needs much work (see Issue #342). 
%    - Issue #255: 
% 
