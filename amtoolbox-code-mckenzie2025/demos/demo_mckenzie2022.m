...
%   .. figure::
%
%      PBC scores calculated based on signals from McKenzie et al. (2018) for various Ambisonic orders (OAs) and with and without diffuse-field equalization (DFE). 
%
%   .. figure::
%
%      PBC dataset normalisation; marker colours get lighter with iterations (see Fig. 2 of McKenzie et al., 2022)
%
%   .. figure::
%
%      PBC scores calculated calculated from frequency-domain data
%
%
%
%   References: mckenzie2022 mckenzie2018
