...
%
%
%   This demo shows how to train an own neural network to obtain localization
%   estimates based on various conditions, subjective data, network parameters 
%   in the context of sound localization, or even for other purposes.
%
%   .. figure::
%
%      Estimated direction (left) and position uncertainty (right) in the horizontal plane
%
%
%   Requirements:
%   -------------
%   
%   This demo requires the Deep Learning Toolbox. If not available, 
%   pre-calculated data will be downloaded and shown. 
%
%   See also: llado2022 exp_llado2022 demo_llado2022
%
%   References: llado2022

%   #Requirement: NNET
%   #Author: Pedro Llado (2022)
%   #Author: Petteri Hyvärinen (2022)
%   #Author: Ville Pulkki (2022)
%   #Author: Michael Mihocic (2023): if Deep Learning Toolbox not available, try loading data from cache, otherwise a warning is displayed
