...
%   #Author: Robert Baumgartner (2010): Original implementation
%   #Author: Piotr Majdak (2024): Adaptions (amt_disp, progress) for AMT 1.6.
...
if plotflag==1
    ...
    % result table
    amt_disp('_______________________________________','documentation');
    amt_disp('                Operator    Paper          Shock','documentation');
    amt_disp(sprintf('#exact/%d:         D          %d             %d',size(cp,1),hitsdp,hitsds),'documentation');
    amt_disp(sprintf('#exact/%d:         C          %d             %d',size(cp,1),hitscp,hitscs),'documentation');
    amt_disp(sprintf('Average error:     D    %5.2f degrees  %5.2f degrees',aedp,aeds),'documentation');
    amt_disp(sprintf('Average error:     C    %5.2f degrees  %5.2f degrees',aecp,aecs),'documentation');
    amt_disp('_______________________________________','documentation');
end
