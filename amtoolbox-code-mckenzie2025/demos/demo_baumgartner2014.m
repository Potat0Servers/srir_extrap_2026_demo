...
%% Check dependencies
if ~exist('regress') && isoctave
  disp('Warning: !!!!!!!!!!')
  disp('Missing dependencies')
  disp('Please install statistics package either')
  disp('pkg install -Forge statistics')
  disp('or (if Ubuntu)')
  disp('sudo apt install octave-statistics')
  disp('and load them')
  disp('pkg load statistics')
  disp('!!!!!!!!!!')
  return
end
