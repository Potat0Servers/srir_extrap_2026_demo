...
%   #Author: Michael Mihocic (2024): figure plotting fixed for Octave.
...
if isoctave % polarplot not supported
    ...
    figure; polarplot([angles angles angles], benefit); title('Benefit');
    figure; polarplot([angles angles angles], weighted_SNR); title('Weighted SNR');
    figure; polarplot([angles angles angles], weighted_bmld); title('Weighted BMLD');
end
