...
%   .. figure::
%
%      The response at channel 16 to a 4-kHz tone at 60 dB SPL
%
%   .. figure::
%
%      The excitation pattern in response to a 4-kHz tone at 60 dB SPL
%
%   See also:  lyon2011
%
%   References: lyon2011
...
%   #Author: Amin Saremi (2016): original implementation
%   #Author: Clara Hollomey (2021): integration in the AMT 1.0
%   #Author: Mihajlo Velimirovic (2023): fix of the SPL
...
%% Create the stimuli: a 100ms-long tone at 4 kHz and 60 dB SPL
Fs= 22050; % this is the default. You can change it by calling the CarfacDesign function.
T= 0.1; % 100 ms length
t=0:(1/Fs):T;
fsig = 4000; 
SPL=60; 
level = 20e-6.* 10.^(SPL/20); % 60 dB SPL
...
figure
plot(Pos, db(norm_Fr));
title('The Excitation Pattern in response to 4-kHz tone at 60 dB SPL');
xlabel('Cochlear distance (in mm) from the apex')
