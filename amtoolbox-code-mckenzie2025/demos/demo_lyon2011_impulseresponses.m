...
%   .. figure::
%
%      Impulse responses at a center frequency of 4 kHz
%
%   .. figure::
%
%      Equivalent rectangular bandwidth at low intensities
%
%   .. figure::
%
%      The filter bandwidth as a function of intensity
%
%   See also:  lyon2011
%
%   References: lyon2011
...
xlabel('CF [Hz]')
legend('CARFAC model','Experimental data: Glasberg and Moore (1990)','Location','best');
%%
figure
semilogy(spl,QERB(:,4))
