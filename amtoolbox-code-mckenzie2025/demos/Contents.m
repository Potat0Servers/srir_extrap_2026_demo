...
%     DEMO_LYON2011                               - CARFAC model (one-capacitor version, aka CARFAC v1) 
%     DEMO_LYON2011_COMPRESSIVEFUNCTIONS          - CARFAC v1: Demonstration of the cochlear compression
%     DEMO_LYON2011_IMPULSERESPONSES              - CARFAC v1: Demonstration of the impulse responses
%     DEMO_LYON2024                               - CARFAC model (two-capacitors version, aka CARFAC v2)
...
%     demo_felsheim2024 - Adaptive leaky-integrate and firing probability (aLIFP) model of an electrically stimulated nerve fiber
...
%     demo_paulick2024 - Computational auditory signal processing and perception (CASP) model 
...
%
%   Loudness
%     DEMO_BRAMSLOW2004 - Loudness model considering hearing loss (AUDMOD)
%     DEMO_CHEN2011              - Fast excitation pattern estimation
%     demo_moore2016 - Binaural loudness model
%
...
%     demo_may2011 - Model estimating the azimuth angles of concurrent speakers
