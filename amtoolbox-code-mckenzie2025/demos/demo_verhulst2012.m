...
%   #Requirements: Python Python-numpy Python-scipy
%   #Author: Alessandro Altoe (2014)
%   #Author: Michael Mihocic (2024): Check for Python implemented -> warning if Python is not available
...
if system('python -V') == 9009
    % Python not found
    amt_disp(' '); % force line break
    warning([mfilename ' requires Python.']);
    return;
end
