...
%
%   Input parameters:
%     x   : Binaural impulse responses. It can be a SOFA structure or a 
%           matrix with the size (*time* x *direction* x *ear*).
...
%   smoothing based on Gammatone filters with a variable bandwidth controlled by *B*.
%
