...
%   Usage: 
%     data = data_glasberg2002('tfOuterMiddle1997');
%     data = data_glasberg2002('tfOuterMiddle2007');
%     data = data_glasberg2002('specLoud');
%     data = data_glasberg2002(..,'fieldType','free');
%     data = data_glasberg2002(..,'fieldType','diffuse');
%
%   `data_glasberg2002('tfOuterMiddle1997');` provides the filter coefficients of the outer 
%   and middle ear as determined in Glasberg et al. (2002). 
%   
%   `data_glasberg2002('tfOuterMiddle2007');` provides the filter coefficients of the outer 
%   and middle ear as determined in Glasberg et al. (2002) but updated in 2006 or 2007
%   (the implementation here is unclear and needs a check). 
%   

%   #Author: Thomas Deppisch (2017): original implementation
%   #Author: Piotr Majdak (2020): rudimentory integraton in the AMT
%   #Author: Piotr Majdak (2024): documentation update, still work required. 
