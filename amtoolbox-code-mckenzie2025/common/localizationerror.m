...
%                          median plane only, i.e., within the lateral angles of $\pm$ 30 $^\circ$. *meta* provides
...
%
%     'precLcentral'       As `'precL'` but considering only responses $\pm$ 30 $^\circ$
...
%                          in the range of $\pm$ 30 $^\circ$, only. Reference unclear.
%
...
%                          polar errors outside the quadrant defined by errors within $\pm$ 45 $^\circ$. The
...
%                          polar errors within $\pm$ 90 $^\circ$. *meta* and *par* provide the information
...
%                          angles in the range of $\pm$ 30 $^\circ$, only.  Reference unclear.
%
...
%                          $\pm$ 30 $^\circ$. Outlier distance criterion is $40^\circ$. The SIRP is run separately
...
%
%
%   References: middlebrooks1999nonindividualized macpherson2003ripples carlile1997errors majdak2010 majdak2011 macpherson2000level mclachlan2024
%
