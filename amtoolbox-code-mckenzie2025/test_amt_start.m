...
disp(' --> TEST AMT_START: SILENT, REDO');
disp(' ');disp(' ');disp(' ');
...
disp(' --> TEST AMT_START: NORMAL, REDO');
amt_start('redo');
[flags, keyvalues] = amt_configuration;
assert(strcmp(flags.cachemode, 'redo'))
...
disp(' --> TEST AMT_START: NORMAL, LOCAL ONLY');
amt_start('localonly');
[flags, keyvalues] = amt_configuration;
...
disp(' --> TEST AMT_START: NORMAL, CACHED');
amt_start('cached');
[flags, keyvalues] = amt_configuration;
